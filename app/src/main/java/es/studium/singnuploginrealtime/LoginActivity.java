            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (passwordFromDB.equals(userPassword)) {
                        ...
                        String lvlAccessesDB = snapshot.child(userUsername).child("lvlAccesses").getValue(String.class);
                        if (lvlAccessesDB.equals("user")) {
                            ...
                            startActivity(intent);
                            finish();
                        }else if (lvlAccessesDB.equals("admin")){
