...
import es.studium.singnuploginrealtime.settings.user.editSettings2;
...
public class SettingsActivity2 extends AppCompatActivity {
    ...
    public void EditProfile2(View view)
    {
        Intent intentSettings = new Intent(this, editSettings2.class);
