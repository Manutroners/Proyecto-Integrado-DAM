...
import es.studium.singnuploginrealtime.calendar.user.WeekViewActivity2;
...
public class ProfileActivity2 extends AppCompatActivity implements CalendarAdapter.OnItemListener{
    ...
    private void setMonthView()
    {
        ...
        CalendarAdapter calendarAdapter = new CalendarAdapter(daysInMonth, (CalendarAdapter.OnItemListener) this, username);
    ...
    public void weeklyAction2(View view)
    {
        Intent intentWeek = new Intent(getApplicationContext(), WeekViewActivity2.class);
