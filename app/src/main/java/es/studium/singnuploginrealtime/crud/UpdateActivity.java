package es.studium.singnuploginrealtime.crud;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UpdateActivity.this, "No puedes dejar huecos en blanco", Toast.LENGTH_SHORT).show();

                }else if (uri == null)
                {
                    Toast.makeText(UpdateActivity.this, "Tienes que cambiar la imagen", Toast.LENGTH_SHORT).show();
                }else {
                    saveData();
