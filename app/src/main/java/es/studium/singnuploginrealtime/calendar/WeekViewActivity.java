...
public class WeekViewActivity extends AppCompatActivity implements CalendarAdapter.OnItemListener
{
                ...
                if (snapshot.exists()){
                    ...
                    eventListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                        ...
                        public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(WeekViewActivity.this, "Deleted", Toast.LENGTH_SHORT).show();

                            Intent intentWeekData = new Intent(getApplicationContext(),WeekViewActivity.class);
    ...
    public void newEventAction(View view) {
        Intent intentNewEvent = new Intent(getApplicationContext(),EventEditActivity.class);
